$(document).ready(() => {
  const containerData = {
    carousel_topPick: {
      ...
      apiEndpoint: "http://localhost:3001/api/v1/hotels?type=1",
    },
    carousel_budgetFriendly: {
      containerId: "carousel_budgetFriendly",
      imagePath: "/image/BudgetFriendly/",
      apiEndpoint: "http://localhost:3001/api/v1/hotels?type=2",
    },
    carousel_favorite: {
      containerId: "carousel_Trending",
      imagePath: "/image/TrendingGuestHouse/",
      apiEndpoint: "http://localhost:3001/api/v1/hotels?type=3",
    },
  };
