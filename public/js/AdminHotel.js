$(document).ready(function () {
  ...
  function renderPage() {
    $.ajax({
      url: "http://localhost:3001/api/v1/users/getAllUser",
      method: "GET",
  ...
  $(".confirm-delete").click(function () {
    ...
    $.ajax({
      url: `http://localhost:3001/api/v1/users/deleteUser/${id}`,
      method: "DELETE",
      success: function (data) {
        // Xử lý thành công
        $(".popup-overlay-delete").hide();
  ...
  $(document).on("click", ".fa-image", function () {
    ...
    $("#imagePopupOverlay").css("display", "block");
    $.ajax({
      url: "http://localhost:3001/api/v1/urlImageHotel/?HotelId=48",
      method: "GET",
      success: function (data) {
        console.log(data);
        ...
        if (data && data.length > 0) {
          ...
          data.forEach(function (image) {
            ...
            imageElement.append("<img src='" + image.url + "' class='popup-image' />");
  ...
  $(document).on("click", ".delete-image-btn", function () {
    ...
    $.ajax({
      url: "http://localhost:3001/api/v1/urlImageHotel/?id=" + id,
      method: "DELETE",
  ...
  $(document).on("click", "#deleteImageBtn", function () {
    ...
    $.ajax({
      url: "http://localhost:3001/api/images/delete",
      method: "POST",
  ...
  $(document).on("click", ".editUser", function () {
    ...
    $.ajax({
      url: `http://localhost:3001/api/v1/users/getDetailUser/${id}`,
      method: "GET",
      success: function (data) {
        console.log("2");
        console.log(data);
        ...
        $(".ebutton").click(function () {
          ...
          $.ajax({
            url: `http://localhost:3001/api/v1/users/editUser/${id}`,
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
