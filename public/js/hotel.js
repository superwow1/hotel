...
$(document).ready(function () {
  ...
  $.ajax({
    url: "http://localhost:3001/api/v1/hotels/" + hotelId,
    method: "GET",
...
$(document).ready(() => {
  ...
  var hotelId = url.substring(url.lastIndexOf("/") + 1);
  $.ajax({
    url: "http://localhost:3001/api/v1/reviews?hotelId=" + hotelId,
    method: "GET",
    success: (data) => {
...
$(document).ready(() => {
  ...
  $.ajax({
    url: "http://localhost:3001/api/v1/rooms?hotelId=" + hotelId,
    method: "GET",
